...
> 2026-03-01系统架构改版，优化数据加载性能问题 【v6】

>>开发计划：通过资产数据模块定义需要在大屏显示的主机
<img width="1677" height="899" alt="image" src="https://github.com/user-attachments/assets/dfaac672-738f-485b-89bd-fa4c8a0a21af" />
...
- 数据大屏：配置zabbix数据源后自动采集zabbix监控数据
...
- 配置管理：可在zabbixwatch上管理被监控主机（直观展示主机的资源使用情况及监控历史趋势），包括添加、删除、编辑信息
...
### v6.0.0 (2026-03-01) - 当前版本

新功能：
- 系统架构调整
- web监控：支持ssl证书
- 主机管理和监控历史数据功能合并，直观展示主机的资源使用情况
...
<img width="1920" height="1080" alt="主机管理中心" src="https://github.com/user-attachments/assets/bab03e74-3680-4a70-a962-54198b46e78b" />
<img width="1920" height="1080" alt="监控指标历史数据" src="https://github.com/user-attachments/assets/e9ae9e51-39c1-4e3d-94df-1e5eba8ea8db" />
